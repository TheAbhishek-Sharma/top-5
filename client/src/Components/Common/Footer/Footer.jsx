            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between">
                    <div className="mb-4 md:mb-0">
                        <h1 className="text-2xl font-bold">ManufactureIndia</h1>
                        <p className="text-sm">Where Innovation Meets Industry.</p>
                        <p className="text-sm">Helpline - +91-8699490011</p>
                        <p className="text-sm">Email - support@manufactureIndia.com</p>
                    </div>
                    <div className="mb-4 md:mb-0">
                ...
                <div className="border-t border-gray-700 mt-4 pt-4 text-center">
                    <p className="text-sm">© Copyright ManufactureIndia. All Rights Reserved.</p>
